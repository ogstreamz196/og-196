...
<div style={{position:"absolute",top:76,fontFamily:body,fontWeight:700,fontSize:27,letterSpacing:7,color:C.silver,opacity:interpolate(f,[12,28],[0,1],{extrapolateRight:"clamp"})}}>START WITH 25 FREE CREDITS</div>
...
<div style={{fontFamily:display,fontSize:76,color:C.red,marginTop:36,opacity:interpolate(f,[58,76],[0,1],{extrapolateRight:"clamp"})}}>CREATE FOR FREE.</div>
