          ...
          <TabsContent value="yours" className="mt-0 space-y-3">
            ...
            {library.isLoading ? (
              <ul
                ...
                aria-busy="true"
                className="divide-y divide-border/40 overflow-hidden rounded-2xl border border-border/60 bg-card/85 backdrop-blur-sm"
              >
                {[0, 1, 2].map((i) => (
              ...
              (() => {
                ...
                return (
                  <div data-testid="library-cards" className="space-y-2">
                    ...
                    <MiniPlayer />
                    <ul className="divide-y divide-border/40 overflow-hidden rounded-2xl border border-border/60 bg-card/85 backdrop-blur-sm">
                      {filtered.map((s) => (
                        <CommunityTrackRow
                          key={s.id}
                          song={s}
