REVOKE EXECUTE ON FUNCTION public.purchase_sports_guide_access() FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.purchase_sports_guide_access() TO service_role;
...
BEGIN
  ...
  VALUES (p_user, v_item.id, v_item.coin_price, 'owned')
